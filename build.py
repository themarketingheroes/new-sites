...
FOOTER = '''<footer>
  <div class="container">
    ...
    <div class="footer-bottom">
      ...
      <div style="opacity: 0.5; font-size: 11px;">Site by Dotoli Digital</div>
    </div>
  </div>
</footer>
...
if (qf) {
  qf.addEventListener('submit', async (e) => {
    ...
    const btn = qf.querySelector('.form-submit');
    btn.disabled = true; btn.textContent = 'Sending...';
    try {
      const res = await fetch(qf.action, {
        method: 'POST',
        body: new FormData(qf),
        headers: { 'Accept': 'application/json' }
      });
      if (res.ok || qf.action.includes('your-formspree-id')) {
        // Treat placeholder Formspree URL as success for local preview
        qf.classList.add('sent');
        qf.querySelector('.form-success').scrollIntoView({ behavior: 'smooth', block: 'center' });
      } else {
        btn.disabled = false; btn.textContent = 'Request my free quote';
        alert('Something went wrong sending the form. Please call us at 954-444-6643.');
      }
    } catch (err) {
      btn.disabled = false; btn.textContent = 'Request my free quote';
      alert('Network issue sending the form. Please call us at 954-444-6643.');
    }
  });
}
</script>
...
<link href="https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wdth,wght@12..96,75..100,400;12..96,75..100,500;12..96,75..100,600;12..96,75..100,700&display=swap" rel="stylesheet">
  ...
  <div class="container">
    <div class="cta-grid">
      <div class="reveal">
        ...
        <div style="display:flex; align-items:center; gap:24px; padding-top: 24px; border-top: 1px solid var(--line);">
          <div>
            ...
            <a href="tel:9544446643" style="font-family: 'Bricolage Grotesque', sans-serif; font-size: 32px; font-weight: 600; color: var(--accent); text-decoration: none; letter-spacing: -0.02em;">954-444-6643</a>
          </div>
        </div>
      </div>
      <div class="cta-form-card reveal">
        ...
        <form id="quote-form" action="https://formspree.io/f/your-formspree-id" method="POST" novalidate>
          <div class="form-grid">
            ...
            <div class="form-field">
              ...
              <input id="phone" name="phone" type="tel" required pattern="[0-9 ()+\\-]{7,}" placeholder="(954) 555-0123" autocomplete="tel" />
              <div class="err">Please enter a valid phone number (at least 7 digits).</div>
            </div>
            <div class="form-field">
            ...
            <div class="form-field">
              ...
              <input id="address" name="address" type="text" required placeholder="Street, city, ZIP" autocomplete="street-address" />
              <div class="err">Please enter the property address.</div>
            </div>
            <div class="form-field">
            ...
            <div class="form-field">
              ...
              <textarea id="notes" name="notes" placeholder="Anything we should know before the walk-through"></textarea>
            </div>
          ...
          <div class="form-success" role="status" aria-live="polite">
            ...
            <p>We will call you within one business day at the number you provided. If it is urgent, call us directly at <a href="tel:9544446643" style="color: var(--accent); font-weight: 600;">954-444-6643</a>.</p>
          </div>
        </form>
      </div>
    </div>
...
home_body = '''<section class="hero hero-tall with-bg-image" style="background-image: url('/img/job-638.jpg'); background-position: center 30%;">
  ...
  <div class="container hero-content">
    <div class="hero-eyebrow"><span class="dot"></span>Same-day callback &middot; South Florida</div>
    ...
    <div class="hero-ctas">
      ...
      <a href="tel:9544446643" class="btn-secondary"><svg class="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>Call 954-444-6643</a>
    </div>
  </div>
</section>
...
<section id="why">
  <div class="container">
    ...
    <div class="manifesto">
      <div class="manifesto-row reveal">
      ...
      <div class="manifesto-row reveal">
        ...
        <p>Homeowners, contractors, and developers hire us once, then keep calling. Repeat clients fill the calendar. Word of mouth fills the rest.</p>
      </div>
      <div class="manifesto-row reveal">
...
<section class="fullbleed-quote">
  <div class="container">
    <blockquote class="reveal">"<span class="accent">Not the cheapest.</span> The one you call when you want it done right the first time."</blockquote>
    <cite>Nataliya Shkurat &middot; CEO &amp; Founder</cite>
  </div>
</section>
...
<section id="services">
  <div class="container">
    ...
    <div class="services-asym" style="margin-top: 64px;">
      <div class="featured-service reveal">
        <span class="tag">Most requested</span>
        <h3>Residential demolition, end to end.</h3>
        <p>Full tear-down, interior gut, pool removal, garage drop. Permit to push on every job. Site swept clean for the next crew.</p>
        <ul class="feat-list">
          <li>Full house tear-down with permit and asbestos coordination</li>
          <li>Interior demo (kitchen, bath, full gut)</li>
          <li>Pool removal and structural back-fill</li>
          <li>Garage and outbuilding removal</li>
        </ul>
        <a href="/residential.html" class="feat-cta">See residential details ''' + ARROW + '''</a>
      </div>
      <div class="secondary-stack">
        <div class="secondary-service reveal">
          <h3>Commercial</h3>
          <p>Strip-outs, full structures, partial demo. Built for GC schedules; we work nights and weekends when the job needs it.</p>
          <a href="/commercial.html" class="sec-cta">Commercial details ''' + ARROW + '''</a>
        </div>
        <div class="secondary-service reveal">
          <h3>Earthwork (add-on)</h3>
          <p>Grading and demucking after demo. Build-ready lot before the next crew shows up. Bundle with your demolition quote.</p>
          <a href="/site-preparation.html" class="sec-cta">Earthwork details ''' + ARROW + '''</a>
        </div>
      </div>
    </div>
...
<section>
  <div class="container">
    ...
    <div class="testimonials-mag">
      <div class="mag-quote reveal">
        <div class="mag-author">
          <div class="city">Boca Raton</div>
          <div class="role">Developer &middot; Repeat client</div>
        </div>
        <div class="mag-text">
          <div class="stars">&starf;&starf;&starf;&starf;&starf;</div>
          <p>"They pulled every permit. Showed up on the day. Finished early. My foundation crew started on schedule for the first time in years."</p>
        </div>
      </div>
      <div class="mag-quote flip reveal">
        <div class="mag-author">
          <div class="city">South Florida</div>
          <div class="role">General Contractor &middot; Repeat client</div>
        </div>
        <div class="mag-text">
          <div class="stars">&starf;&starf;&starf;&starf;&starf;</div>
          <p>"Before I found Nataliya, I had been burned by demo crews who would leave a mess and disappear. Now every demolition job I quote, every interior tear-out I do not want to do myself, I just call her."</p>
        </div>
      </div>
      <div class="mag-quote reveal">
        <div class="mag-author">
        ...
        <div class="mag-text">
          <div class="stars">&starf;&starf;&starf;&starf;&starf;</div>
          <p>"Got three quotes. Nataliya was not the cheapest. She was the only one who came out and walked the property before pricing it. We hired her on the spot."</p>
        </div>
      </div>
    </div>
    <div style="text-align: center; margin-top: 48px;">
